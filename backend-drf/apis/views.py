...
class StockPredictionAPIView(APIView):
    def post(self,request):
        ...
        if(serializer.is_valid()):
            ...
            plot_img_path2 = f'{ticker}_200_dma.png'
            plot_200_dma = save_plot(plot_img_path2)
            ...
            plot_img_path_fnl = f'{ticker}_final_prediction.png'
            plot_prediction = save_plot(plot_img_path_fnl)
